...
RESUME_BRANCH_KEYS = ("use_safe_anchor", "anchor_lambda", "anchor_reference_sha256", "anchor_gradient_budget", "use_cir_training", "cir_alpha", "cir_peer_count", "cir_spatial_radius", "use_hard_background_patch_ranking", "hard_background_ranking_lambda", "hard_background_topk_fraction", "hard_background_margin")
...
SCIENTIFIC_CONFIG_KEYS = SCIENTIFIC_CONFIG_KEYS + ("training_horizon", "primary_horizon", "secondary_horizon", "anchor_target_effective_ratio", "anchor_r_med", "anchor_lambda_old", "use_hard_background_patch_ranking", "hard_background_ranking_lambda", "hard_background_topk_fraction", "hard_background_margin")
...
def parent_scientific_config(config: Mapping[str, Any]) -> dict[str, Any]:
    ...
    parent.update({
        ...
        "use_hard_background_patch_ranking": False,
        "hard_background_ranking_lambda": 0.0,
        "hard_background_topk_fraction": 0.05,
        "hard_background_margin": 0.05,
    })
    return parent
