...
SAVE_PATH="${SAVE_PATH:-runs/phase2b/phase2b_hybrid_alpha01_kreg5e3_lkg1e2_lr5e5_train20_test6medical7to15_fromscratch}"
...
LAMBDA_K="${LAMBDA_K:-0.005}"
HYBRID_ALPHA_MAX="${HYBRID_ALPHA_MAX:-0.1}"
...
echo "==== Train Phase2B hybrid alpha=${HYBRID_ALPHA_MAX} + K-reg lambda_k=${LAMBDA_K} from scratch ===="
