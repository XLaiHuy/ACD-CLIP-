...
echo "CIR/G2-PARITY recorded"
echo "CIR/G3-PREFLIGHT PASS"
echo "CIR/G4-PROFILE PASS"
echo "CIR/G5-SMOKE requires scripts/cir_rmt/smoke_train.sh with real source assets"
