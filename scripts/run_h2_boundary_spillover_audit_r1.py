...
def severity_and_decision(data: dict, interp: dict, fusion: dict, image_struct: dict, tri_rows: list[dict], distance_struct: dict) -> tuple[dict, dict]:
    ...
    decision = {
        ...
        "stage_severity_resolution": "518x518 current-production resized stage maps",
        "stage_severity_ranked": severity_rows,
        "native_stage_interior_ratio_status": "UNDEFINED_EMPTY_INTERIOR_UNDER_EXACT_7X7_MORPHOLOGY",
