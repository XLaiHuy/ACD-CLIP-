#!/usr/bin/env python3
"""Rank all fresh-run epochs from the six Medical test logs."""
...
def main() -> None:
    ...
    for dataset in DATASETS:
        log_path = args.results_root / dataset / "test.log"
    ...
    with args.output_csv.open("w", newline="", encoding="utf-8") as handle:
        ...
        for row in rows:
            writer.writerow(
                [row["epoch"], row["medical_macro_pixel_ap"], row["medical_macro_pixel_auroc"]]
            )
