...
RUN_ROOT="${RUN_ROOT:-${ROOT}/runs/fresh_mvtec_all_source_20260910}"
...
test -s "${ROOT}/dataset/hub/MVTec_all_supervised.jsonl"
...
echo "source_includes=train/good,test/good,test/anomaly_with_official_masks"
