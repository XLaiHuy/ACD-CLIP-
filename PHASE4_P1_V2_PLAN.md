...
| Full factor-aware center loss | Existing center loss picks nearest prototype over all factors | Stronger router/prototype correspondence | Bigger behavior change; needs scale audit | deferred | modify/defer |
| Concept-key router redesign | Current router uses independent MLP logits; concept keys are not routing keys | Better semantic correspondence | Wider router contract change; more checkpoint risk | deferred | modify/defer |
